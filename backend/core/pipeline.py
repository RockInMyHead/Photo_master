...
async def process_folder(
    ...
    *,
    ...
    # МЯГКИЕ параметры: максимальное объединение вариаций одного человека
    link_sim = 0.50      # Еще мягче - объединяет даже разные вариации
    merge_sim = 0.65     # Еще мягче - сливает похожие кластеры
    assign_sim = 0.60    # Мягче - добавляет больше outliers
    min_intra_sim = 0.45 # Мягче - сохраняет больше вариаций в кластере
    assign_margin = 0.03 # Мягче - меньший отрыв от второго кандидата
